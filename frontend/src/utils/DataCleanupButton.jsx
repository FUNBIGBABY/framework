...
function DataCleanupButton() {
  ...
  const handleCleanup = async () => {
    if (
      !window.confirm(
        '⚠️ This will modify all frameworks in Firestore. Continue?'
      )
    ) {
      return
    }
      ...
      <div className="flex items-start space-x-3 mb-4">
        ...
        <div>
          ...
          <ul className="text-sm text-yellow-800 space-y-1 mb-4">
            <li>
              • Remove{' '}
              <code className="bg-yellow-200 px-1 rounded">expertId</code> field
              from frameworks
            </li>
            <li>
              • Fix{' '}
      ...
      {verifyResult && (
        <div className="mt-4 p-4 rounded-lg bg-blue-50 border border-blue-200">
          ...
          <div className="text-sm text-blue-800 space-y-1">
            ...
            <p>
              Still have legacy tenantId: {verifyResult.hasLegacyTenant || 0}
            </p>
            <p>
              Missing publishedToOrganization:{' '}
