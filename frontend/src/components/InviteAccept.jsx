...
/**
 * InviteAccept - Improved Invitation Link Acceptance Page (Fixed Version)
 *
 * ✅ Core fixes:
 * - After accepting the invitation, call refreshUser() to update the AuthContext.
 * - Ensure that the frontend user.joinedOrganization is synchronized immediately.
 *
 * URL: /invite/:token
 */
function InviteAccept() {
  ...
  // Loading invitation link information
  useEffect(() => {
    loadInviteInfo()
  ...
  const loadInviteInfo = async () => {
    try {
      ...
      // Check if the invitation link is valid.
      if (!info.isActive) {
  ...
  const handleAcceptInvite = async () => {
    if (!user) {
      // Not logged in - Redirected to the login page, and will return after logging in.
    ...
    try {
      ...
      if (result.success) {
        ...
        // ✅ Core fix: Immediately refresh user data
        ...
        // ✅ Fix: Redirects to the user's own organization page
        // After user C joins A's organization, they should access /ai-readiness4/organization
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-gray-900">
                {inviteInfo.usedCount} /{' '}
                {inviteInfo.maxUses === -1 ? '∞' : inviteInfo.maxUses}
              </span>
            </div>
          </div>
        </div>
          ...
          <ul className="space-y-2">
            <li className="flex items-start">
              ...
              <span className="text-gray-700 text-sm">
                Share your frameworks with the team
              </span>
            </li>
            <li className="flex items-start">
              <svg
              ...
              <span className="text-gray-700 text-sm">
                View shared frameworks from other members
              </span>
            </li>
            <li className="flex items-start">
              <svg
            ...
            <li className="flex items-start">
              ...
              <span className="text-gray-700 text-sm">
                Your own workspace remains independent
              </span>
            </li>
          </ul>
        </div>
