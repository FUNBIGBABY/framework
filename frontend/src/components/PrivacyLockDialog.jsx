...
/**
 * Privacy Protection Lock State Toggle Confirmation Dialog Box
 *
 * @param {boolean} isOpen - Open dialog box?
 * @param {boolean} currentLockState - Current Lock state (true = ON)
...
export default function PrivacyLockDialog({
  ...
  // The dialog box content is determined by the current status.
  const isUnlocking = currentLockState === true // Change from ON to OFF
