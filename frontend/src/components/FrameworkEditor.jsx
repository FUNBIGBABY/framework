...
function FrameworkEditor() {
  ...
  */
  ...
  // 🔥 Update: Re-generate button handler - starts regeneration directly and displays a loading dialog.
  const handleRegenerate = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const artefactVariants =
          regeneratedFw.artefact_variants ||
        ...
        console.log(
          '📦 Updated artefact_variants:',
          artefactVariants.length,
          'items'
        )
        ...
        setIsSaved(false) // Mark as unsaved to trigger automatic saving.
  ...
  const renderContent = () => {
    switch (activeSection) {
        ...
        return (
          <div>
            ...
            <div className="space-y-6">
              ...
              {/*Added: Third row - Points of View (POV) */}
              <div className="mt-6">
                ...
                {(() => {
                  // Attempt to parse POV from _raw
                  let pov = []

                  try {
                    // If _raw is a string, parse it.
                    const rawData =
                  ...
                  if (Array.isArray(pov) && pov.length > 0) {
                    // POV data is available - a list of blue cards is displayed.
                    return (
                    ...
                    // No POV data - grayed-out warning displayed
                    return (
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      ...
                      <div className="flex items-start space-x-3 p-3 bg-white rounded-md">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-gray-600 mt-0.5">
                            Framework is comprehensive, well-structured, and
                            ready for deployment. All key sections are complete
                      ...
                      <div className="flex items-start space-x-3 p-3 bg-white rounded-md">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-gray-600 mt-0.5">
                            Framework has good structure but may benefit from
                            refinement. Consider adding more details or
                            reviewing some sections.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 p-3 bg-white rounded-md">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-gray-600 mt-0.5">
                            Framework needs significant development. Use the
                            Re-generate button to improve quality or manually
                            add more content.
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-blue-200">
                    <div className="flex items-start space-x-2">
                      ...
                      <p className="text-xs text-gray-600">
                        <strong>Note:</strong> Confidence scores are currently
                        generated based on framework completeness and structure.
                        The score reflects the initial quality of the source
      ...
      case 'steps':
        return (
          <div>
            {/* Title row: Add a Manual Merge button */}
  ...
  return (
    <>
      {/* ========== Conditional rendering: Manual Merge Mode vs AI Merge Mode vs Normal Editing Mode ========== */}
      {isInMergeMode && mergeMode === 'manual' ? (
        // Manual Merge Mode interface
        <ManualMergeMode
        ...
        // New feature: AI Merge Mode interface
        <AIMergeMode
          frameworks={frameworkData.steps || []}
          onExit={() => {
            setIsInMergeMode(false)
