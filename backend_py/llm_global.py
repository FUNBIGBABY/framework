...
def build_mock_framework(md: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if "compliance" in title_lower or "audit" in title_lower or "risk" in title_lower:
        ...
        primary_purpose = (
            "Help stakeholders understand the compliance posture and key risk controls."
        )
        optional_arts = [
        ...
        primary_purpose = (
            "Summarise the structure, metrics and guardrails of a wellbeing program."
        )
        optional_arts = [
            "Wellbeing Dashboard",
        ...
        primary_purpose = (
            "Explain the framework, key responsibilities and implementation guidance."
        )
        optional_arts = [
    ...
    # ===== NEW: mock artefact_variants -> multiple independent artefacts =====
    ...
    # ====== Return mock framework (only artefact-related fields changed, others remain unchanged) ======
    return {
        ...
        "primary_artefact": {
            ...
            "variant_id": main_variant_id,  # 🔥 key: points to artefact_variants[0].id
        },
        ...
        "artefact_variants": artefact_variants,  # 🔥 multiple independent artefacts
    }
...
def main():
    ...
    ap.add_argument(
        "--dry-run", action="store_true", help="force mock output without calling API"
    )
    args = ap.parse_args()
