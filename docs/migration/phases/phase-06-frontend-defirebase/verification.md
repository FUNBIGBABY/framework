...
Authenticated browser smoke remains `not run` because the complete live
environment is unavailable and the Docker builder remains incompatible. Host
unit/static evidence may miss browser-cookie, live REST, or container
...
relying on these flows. This transcription did not rerun browser or live-system
verification.
